 ...
 */
    ...
    MON("whale sperm", S_JELLY,
	LVL(8, 10, 6, 10, 0), G_NOGEN,
	A(ATTK(AT_BITE, AD_PREG, 0, 0), ATTK(AT_BITE, AD_ACID, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(50, 40, 0, MS_SILENT, MZ_MEDIUM), MR_ACID|MR_STONE, 0,
	M1_BREATHLESS|M1_AMORPHOUS|M1_NOEYES|M1_NOLIMBS|M1_MINDLESS|M1_NOTAKE,
	M2_HOSTILE|M2_NEUTER, 0, HI_DOMESTIC),
/*
 * balkans
 */
    MON("balkan", S_BALKAN,
 ...
 */
    ...
    MON("dogcow", S_QUADRUPED,
	LVL(24, 12, 2, 0, 0), (G_GENO|1),
	A(ATTK(AT_BUTT, AD_MOOF, 0, 0), ATTK(AT_BUTT, AD_PHYS, 6, 12),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(3800, 800, 0, MS_MOOF, MZ_LARGE), 0, 0,
	M1_ANIMAL|M1_THICK_HIDE|M1_NOHANDS|M1_HERBIVORE,
	M2_HOSTILE|M2_STRONG, M3_INFRAVISIBLE, HI_LORD),
/*
 * rodents
 */
 ...
 */
    MON("gosling", S_GOOSE,
	LVL(2, 16, 7, 0, 0), (G_GENO|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(100, 100, 0, MS_HONK, MZ_SMALL), 0, 0,
	M1_FLY|M1_ANIMAL|M1_NOHANDS|M1_OMNIVORE,
	M2_WANDER|M2_DOMESTIC, M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("goose", S_GOOSE,
	LVL(4, 20, 6, 0, 0), (G_GENO|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 4), ATTK(AT_BITE, AD_BLND, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(200, 200, 0, MS_HONK, MZ_SMALL), MR_SLEEP, 0,
	M1_FLY|M1_ANIMAL|M1_NOHANDS|M1_OMNIVORE,
	M2_WANDER|M2_DOMESTIC, M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("Canadian goose", S_GOOSE,
	LVL(6, 20, 6, 0, 0), (G_GENO|2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 8), ATTK(AT_BITE, AD_BLND, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(300, 300, 0, MS_HONK, MZ_SMALL), MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_ANIMAL|M1_NOHANDS|M1_POIS|M1_REGEN|M1_OMNIVORE,
	M2_DOMESTIC, M3_INFRAVISIBLE, HI_DOMESTIC),
    MON("morbidly obese goose", S_GOOSE,
	LVL(8, 5, 3, 0, 0), (G_GENO|2),
	A(ATTK(AT_BITE, AD_PHYS, 2, 10), ATTK(AT_BITE, AD_BLND, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(600, 600, 0, MS_HONK, MZ_LARGE), MR_SLEEP|MR_POISON, 0,
	M1_ANIMAL|M1_NOHANDS|M1_POIS|M1_REGEN|M1_OMNIVORE,
	M2_DOMESTIC, M3_INFRAVISIBLE, HI_DOMESTIC),
/*
 * Centaurs
 */
 ...
 */
    ...
    MON("PDEng elemental", S_ELEMENTAL,
	LVL(8, 6, 2, 30, 0), (G_NOCORPSE|1),
 ...
 */
	...
	M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_NOTAKE,
	M2_HOSTILE|M2_NEUTER, 0, CLR_MAGENTA),
    MON("teflon fungus", S_FUNGUS,
	LVL(4, 1, 5, 0, 0), G_NOGEN,
	A(ATTK(AT_TUCH, AD_PHYS, 1, 6), ATTK(AT_TUCH, AD_STCK, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(100, 100, 0, MS_SILENT, MZ_SMALL), MR_DISINT, MR_DISINT,
	M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_NOTAKE,
 ...
 */
    ...
    MON("Policy 71 Lieutenant", S_KOP,
...
# ifdef MENTALPLYS
	A(ATTK(AT_WEAP, AD_PHYS, 2, 10), ATTK(AT_BITE, AD_DRLI, 1, 12),
	  ATTK(AT_GAZE, AD_PLYM, 4, 4), NO_ATTK, NO_ATTK, NO_ATTK),
# else
	A(ATTK(AT_WEAP, AD_PHYS, 2, 10), ATTK(AT_BITE, AD_DRLI, 1, 12),
 ...
 */
    ...
    MON("two-headed monkey", S_YETI,
	LVL(2, 12, 6, 0, 0), G_NOGEN, /* Only appears via beheading */
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_BITE, AD_PHYS, 1, 3),
	  ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(100, 50, 0, MS_GROWL, MZ_SMALL), 0, 0,
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE, 0, M3_INFRAVISIBLE, CLR_YELLOW),
    MON("three-headed monkey", S_YETI,
	LVL(2, 12, 6, 0, 0), (G_GENO|2),
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_BITE, AD_PHYS, 1, 3),
	  ATTK(AT_BITE, AD_PHYS, 1, 4), ATTK(AT_BITE, AD_PHYS, 1, 5),
	  NO_ATTK, NO_ATTK),
	SIZ(100, 50, 0, MS_GROWL, MZ_SMALL), 0, 0,
	M1_ANIMAL|M1_HUMANOID|M1_CARNIVORE, 0, M3_INFRAVISIBLE, CLR_CYAN),
    MON("ape", S_YETI,
 ...
 */
    ...
    MON("J. Walter Weatherman", S_HUMAN,
	LVL(25, 15, 7, 50, 0), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_GAZE, AD_LESS, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE|M1_NOHANDS, /* close enough */
	M2_NOPOLY|M2_HUMAN|M2_MALE|M2_PNAME, M3_INFRAVISIBLE, HI_DOMESTIC),
 ...
 */
    ...
    MON("singing shark", S_EEL,
	LVL(7, 14, 0, 0, 0), (G_GENO|1),
	A(ATTK(AT_BITE, AD_PHYS, 6, 6), ATTK(AT_GAZE, AD_SING, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(500, 350, 4, MS_SILENT, MZ_LARGE), MR_COLD, 0,
	M1_FLY|M1_AMPHIBIOUS|M1_ANIMAL|M1_SLITHY|M1_NOLIMBS|
	  M1_CARNIVORE|M1_OVIPAROUS|M1_THICK_HIDE|M1_NOTAKE,
	M2_HOSTILE, 0, CLR_GRAY),
 ...
 */
	...
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
	M2_HOSTILE, 0, CLR_BROWN),
    MON("hypnotoad", S_LIZARD,
	LVL(4, 6, 7, 0, 0), G_GENO,
	A(ATTK(AT_BITE, AD_PHYS, 1, 5), ATTK(AT_GAZE, AD_SLEE, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(50, 50, 0, MS_SILENT, MZ_SMALL), MR_SLEEP, MR_SLEEP,
 ...
 */
	...
	M2_NOPOLY|M2_HUMAN|M2_PNAME|M2_PEACEFUL|M2_STRONG|M2_MALE|
	  M2_COLLECT|M2_MAGIC,
	M3_CLOSE|M3_INFRAVISIBLE, CLR_CYAN),
/*
 * quest nemeses
 */
    MON("MacGregor", S_HUMAN,
	LVL(16, 12, 0, 10, -15), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 3, 8), ATTK(AT_KICK, AD_PHYS, 2, 8),
	  ATTK(AT_GAZE, AD_CONF, 0, 0), ATTK(AT_MAGC, AD_MAGM, 2, 6),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 500, 0, MS_NEMESIS, MZ_HUMAN),
	MR_FIRE|MR_STONE|MR_POISON, 0,
	M1_OMNIVORE|M1_SEE_INVIS,
	M2_NOPOLY|M2_PNAME|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|
	  M2_COLLECT|M2_STALK|M2_FEMALE,
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_GUARDIAN, MZ_TINY), 0, 0,
	M1_TUNNEL|M1_NEEDPICK|M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_PEACEFUL|M2_STRONG|M2_COLLECT, M3_INFRAVISIBLE,
	HI_DOMESTIC),
