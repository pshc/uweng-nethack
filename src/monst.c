 ...
 */
	...
	A(ATTK(AT_BUTT, AD_PHYS, 7, 6), ATTK(AT_BUTT, AD_PHYS, 7, 6),
	  ATTK(AT_BUTT, AD_MOOF, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	LVL(16, 12, 0, 10, -15), (G_NOGEN|G_UNIQ|G_NOCORPSE),
	...
	MR_FIRE|MR_STONE|MR_POISON|MR_DISINT, 0,
