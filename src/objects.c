...
SPELL("drilling",             "parchment",   P_MATTER_SPELL, 19,  6, 5, 1, RAY,       HI_PAPER),
SPELL("magic missile",   "vellum",      P_ATTACK_SPELL, 44,  2, 2, 1, RAY,       HI_PAPER),
SPELL("fireball",        "ragged",      P_ATTACK_SPELL, 19,  4, 4, 1, RAY,       HI_PAPER),
SPELL("cone of cold",    "dog eared",   P_ATTACK_SPELL, 9,  7, 4, 1, RAY,       HI_PAPER),
...
SPELL("wizard lock",     "dark green",  P_MATTER_SPELL, 28,  3, 2, 1, IMMEDIATE, CLR_GREEN),
SPELL("create monster",  "turquoise",   P_CLERIC_SPELL, 34,  3, 2, 1, NODIR,     CLR_BRIGHT_CYAN),
...
WAND("striking",       "ebony",    70, 150, 1, IMMEDIATE, WOOD,     HI_WOOD),
