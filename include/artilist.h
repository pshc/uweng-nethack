...
A("Magicbane",			ATHAME,
	...
	STUN(3,4),	DFNS(AD_MAGM),	NO_CARY,	0, A_NEUTRAL, PM_WIZZARD, NON_PM, 3500L ),
...
A("The Eye of the Aethiopica",	AMULET_OF_ESP,
	...
	NO_ATTK,	NO_DFNS,	CARY(AD_MAGM),
	CREATE_PORTAL,	A_NEUTRAL, PM_WIZZARD, NON_PM, 4000L ),

A("The Tool",	CRESCENT_WRENCH,
	(SPFX_NOGEN|SPFX_RESTR|SPFX_INTEL),
	(SPFX_WARN|SPFX_HALRES|SPFX_SEARCH|SPFX_SEEK|SPFX_REFLECT), 0,
	ELEC(0,8),	DRLI(0,0),	NO_CARY,
